...
@section('content')
    ...
    <p style="margin-bottom: 24px;">This is a friendly reminder that your <strong>{{ $subscription->plan->name }}</strong> subscription is set to expire on <strong style="color: #b45309;">{{ $subscription->end_date->format('M d, Y') }}</strong>.</p>
