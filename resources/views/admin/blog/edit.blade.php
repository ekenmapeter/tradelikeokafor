    ...
    <form action="{{ route('admin.blog.update', $post) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <div class="dark:text-gray-900">
                <textarea name="content" id="editor" rows="15" class="w-full px-4 py-2 border rounded-lg focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('content', $post->content) }}</textarea>
            </div>
        </div>
