...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900" x-data="{ sidebarOpen: false }">
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div
            ...
            @php
                $dashboardRoute = Auth::user()->isAdmin() ? route('admin.dashboard') : route('admin.blog.index');
            @endphp
            ...
            <nav class="mt-6 px-4 space-y-2">
                @if(Auth::user()->isAdmin())
                    ...
                    <a href="{{ route('admin.profit-records.index') }}"
                        class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.profit-records.*') ? 'bg-green-50 text-green-700 font-semibold dark:bg-gray-700 dark:text-green-400 border-l-4 border-green-600' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-green-600' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.blog.index') }}"
                    class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.blog.index') || request()->routeIs('admin.blog.create') || request()->routeIs('admin.blog.edit') || request()->routeIs('admin.blog.views') ? 'bg-green-50 text-green-700 font-semibold dark:bg-gray-700 dark:text-green-400 border-l-4 border-green-600' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-green-600' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.blog.analytics') }}"
                    class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.blog.analytics') ? 'bg-green-50 text-green-700 font-semibold dark:bg-gray-700 dark:text-green-400 border-l-4 border-green-600' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-green-600' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if(Auth::user()->isAdmin())
                    ...
                    <a href="{{ route('admin.ebook-orders.index') }}"
                        class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.ebook-orders.*') ? 'bg-green-50 text-green-700 font-semibold dark:bg-gray-700 dark:text-green-400 border-l-4 border-green-600' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-green-600' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <div class="mr-2">{{ Auth::user()->name }} ({{ Auth::user()->role === 'admin' ? 'Admin' : 'Moderator' }})</div>
                        <div
