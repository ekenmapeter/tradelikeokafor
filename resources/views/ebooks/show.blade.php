...
<body style="background: #000;">
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md d-flex align-items-center">
                    <p class="mb-0 phone"><span class="mailus">Call Support:</span> <a
                            ...
                            href="email:support@tradelikeokafor.com"><span>support@tradelikeokafor.com</span></a></p>
                </div>
                        ...
                        <p class="mb-0 d-flex">
                            <a href="https://t.me/+xYVyIeI8RMMwZjE0" target="_blank"
                                class="d-flex align-items-center justify-content-center"><span
                                    class="fa-brands fa-telegram"></span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="{{ route('mentorship') }}"
                            style="background: #02be2e!important; font-weight: 600; color: #ffffff!important; border-radius: 50px; padding: 8px 20px!important; margin-left: 5px; margin-top: 0!important;"
                    ...
                    <li class="nav-item active"><a href="{{ route('ebooks.index') }}"
                            style="background: #02be2e!important; font-weight: 600; color: #ffffff!important; border-radius: 50px; padding: 8px 20px!important; margin-left: 5px; margin-top: 0!important;"
                            class="nav-link">Ebooks</a></li>
                    <li class="nav-item"><a href="https://t.me/+xYVyIeI8RMMwZjE0"
                            style="background: #02be2e!important; color: #ffffff!important; font-weight: 600; border-radius: 50px; padding: 8px 20px!important; margin-left: 5px; margin-top: 0!important;"
    ...
    <section class="purchase-section">
        <div class="container">
            <a href="{{ route('ebooks.index') }}" class="back-link"><i class="fas fa-arrow-left"></i> Back to
                Ebooks</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-4">
                    <div class="ebook-detail-card">
                        ...
                        <div class="ebook-detail-body">
                            ...
                            <p style="color: #777; font-size: 0.85rem;"><i class="fas fa-file-pdf mr-1"></i> PDF
                                Format — Instant delivery after payment verification</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="purchase-form-card">
                        ...
                        <form action="{{ route('ebooks.purchase', $ebook->slug) }}" method="POST"
                            ...
                            <div class="form-group">
                                <label for="customer_email"><i class="fas fa-envelope mr-1"></i> Email Address
                                    *</label>
                                <input type="email" name="customer_email" id="customer_email"
                                    value="{{ old('customer_email') }}" required
                                    placeholder="your@email.com — ebook will be sent here">
                            ...
                            <div class="form-group">
                                <label for="customer_phone"><i class="fas fa-phone mr-1"></i> Phone Number
                                    (Optional)</label>
                                <input type="text" name="customer_phone" id="customer_phone"
                                    value="{{ old('customer_phone') }}" placeholder="+234...">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="payment-options">
                                    <label
                                        class="payment-option {{ old('payment_method') === 'paypal' ? 'active' : '' }}"
                                        id="paypalOption">
                                    ...
                                    <label
                                        class="payment-option {{ old('payment_method') === 'bank_transfer' ? 'active' : '' }}"
                                        id="bankOption">
                            ...
                            <div class="payment-details" id="paypalDetails">
                                ...
                                <p>Send <span class="detail-value">${{ number_format($ebook->price, 2) }}</span> to
                                    the PayPal email below:</p>
                                <p style="background: #1a1a1a; padding: 12px; border-radius: 8px; text-align: center;">
                                    <span class="detail-value"
                                        style="font-size: 1.1rem;">{{ $settings['paypal_email'] ?? 'support@tradelikeokafor.com' }}</span>
                                </p>
                                <p style="color: #f59e0b; font-size: 0.85rem; margin-top: 10px;"><i
                                        class="fas fa-info-circle mr-1"></i> Use "Friends & Family" option. After
                                    payment, take a screenshot and upload it below.</p>
                            </div>

                            {{-- Bank Transfer Details --}}
                            <div class="payment-details" id="bankDetails">
                                <h4><i class="fas fa-university mr-1"></i> Bank Transfer Details</h4>
                                <p>Transfer <span class="detail-value">
                                        @if ($ebook->price_naira)
                                            ₦{{ number_format($ebook->price_naira, 0) }}
                                        @else
                                            ${{ number_format($ebook->price, 2) }}
                                        @endif
                                    </span> to the account below:</p>
                                <div style="background: #1a1a1a; padding: 16px; border-radius: 8px; margin-top: 10px;">
                                    <p style="margin-bottom: 8px;">Bank: <span
                                            class="detail-value">{{ $settings['bank_name'] ?? 'N/A' }}</span></p>
                                    <p style="margin-bottom: 8px;">Account Name: <span
                                            class="detail-value">{{ $settings['account_name'] ?? 'N/A' }}</span></p>
                                    <p style="margin-bottom: 0;">Account Number: <span
                                            class="detail-value">{{ $settings['account_number'] ?? 'N/A' }}</span></p>
                                </div>
                                <p style="color: #f59e0b; font-size: 0.85rem; margin-top: 10px;"><i
                                        class="fas fa-info-circle mr-1"></i> After payment, take a screenshot of the
                                    transfer receipt and upload it below.</p>
                            </div>

                            <div class="form-group">
                                <label for="payment_proof"><i class="fas fa-cloud-upload-alt mr-1"></i> Upload Payment
                                    Proof *</label>
                                <input type="file" name="payment_proof" id="payment_proof" accept="image/*"
                                    required>
                                <p style="color: #777; font-size: 0.8rem; margin-top: 5px;">Accepted: JPG, PNG, GIF.
                                    Max 5MB.</p>
                                @error('payment_proof')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            ...
                            <button type="submit" class="btn-submit-purchase" id="submitBtn">
                                <i class="fas fa-lock mr-2"></i> Submit Payment — <span
                                    id="displayPrice">${{ number_format($ebook->price, 2) }} @if ($ebook->price_naira)
                                        / ₦{{ number_format($ebook->price_naira, 0) }}
                                    @endif
                                </span>
                            </button>
